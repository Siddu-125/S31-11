    ...
    <div className="bg-gray-100 min-h-screen">
      ...
      <section className="py-20 px-4 text-center">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-4xl font-bold mb-4">Online Medical System</h1>
            ...
            {role === 'patient' && (
              <React.Fragment>
                <Link to="/available-doctors">
                  <button className="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-6 rounded mr-2">Book Appointment</button>
                </Link>
                <Link to="/booking-status">
                  <button className="bg-transparent border border-blue-500 text-brown-500 hover:text-black hover:bg-brown-500 font-bold py-2 px-6 mr-2 rounded mt-2">Booking Status</button>
                </Link>
              </React.Fragment>
            )}
            {role === 'doctor' && (
              ...
              <>
                ...
                {showMore && (
                  <div className="mt-8 text-left bg-white p-6 rounded shadow-lg">
                    <h2 className="text-2xl font-bold mb-4">About Our Consultation</h2>
          ...
          <div className="flex flex-wrap justify-center">
            <div className="w-full sm:w-1/2 lg:w-1/3 px-4 mb-8">
              <div className="bg-blue-100 p-6 rounded">
                <h3 className="text-xl font-semibold mb-4">Comfortable</h3>
                <p className="text-gray-700">Access healthcare services remotely, at your comfort.</p>
              </div>
            </div>
            <div className="w-full sm:w-1/2 lg:w-1/3 px-4 mb-8">
              <div className="bg-blue-100 p-6 rounded">
            ...
            <div className="w-full sm:w-1/2 lg:w-1/3 px-4 mb-8">
              <div className="bg-blue-100 p-6 rounded">
                ...
                <p className="text-gray-700">Compared to Hospital these appointments are less expensive.</p>
              </div>
            </div>
          </div>
        </div>
